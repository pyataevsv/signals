        ...
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <View style={{ marginRight: 10, marginTop: 10, flexDirection: 'row' }} >
                    <View style={styles.profitArrow}>
                        <Image style={{ resizeMode: 'contain', width: 30, height: 30 }} source={require('../assets/icons/arrow_down.png')} />
                    </View>
            ...
            >
                ...
                <View style={{ alignItems: 'center', position: 'absolute', left: -23, top: -15, zIndex: 1 }}>
                    ...
                    <Image blurRadius={1} source={require('../assets/icons/doto.png')} />

                    <Text style={{ position: 'absolute', top: 30, color: fontColor }}>{minPoint}</Text>
                </View>
                <View style={{ alignItems: 'center', position: 'absolute', left: -18 + openPricePosition, top: -15, zIndex: 0 }}>
                    <Image blurRadius={1} source={require('../assets/icons/doto.png')} />
                    <Text style={{ position: 'absolute', top: 30, color: fontColor }}>{signalData.graph.open_price}</Text>
                </View>
                <View style={{ alignItems: 'center', position: 'absolute', right: -23, top: -15, zIndex: 1 }}>
                    <Image blurRadius={1} source={require('../assets/icons/doto.png')} />
                    <Text style={{ position: 'absolute', top: 30, color: fontColor }}>{maxPoint}</Text>
                </View>
                ...
                <View style={{ alignItems: 'center', position: 'absolute', left: currentPricePosition, top: -13, zIndex: 2 }}>
                    ...
                    <Text style={{ position: 'absolute', top: -10, color: fontColor }}>{signalData.graph.current_price}</Text>
                </View>
            </View>
        </View >
    )
